...
function Dropzone() {
  ...
  const onDrop = (acceptedFiles: File[]) => {
    acceptedFiles.forEach((file) => {
      ...
      reader.onabort = () => console.log("file reading wad aborted");
  ...
  {({
    ...
    <section>
      ...
      className={cn(
        ...
        isDragActive ? "bg-[#035FFE] text-white animate-pulse" : "bg-slate-100/50 dark:bg-slate-800/80 text-slate-400 cursor-pointer"
      )}
      >
        <input {...getInputProps()} />
